    ...
    <div className="font-sans">
      <section className="bg-gradient-to-br from-primary/90 to-primary text-primary-foreground px-8 py-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="opacity-80 text-lg mb-8">Bienvenue sur notre site web</p>
      ...
      <section className="px-8 py-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground leading-relaxed">Nous sommes une entreprise passionnée, dédiée à offrir un service de qualité à nos clients. Contactez-nous pour en savoir plus.</p>
        </div>
      </section>
