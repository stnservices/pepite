    ...
    <div className="font-sans">
      ...
      <section className="relative bg-gradient-to-br from-amber-900 via-stone-900 to-stone-950 text-white px-8 py-20">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-amber-400 text-sm uppercase tracking-[0.3em] mb-4">Bine ați venit la</p>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">{businessName}</h1>
          <p className="text-stone-300 text-lg mb-8">O experiență culinară unică în inima orașului {city || 'orașul'}</p>
      ...
      <section className="bg-stone-50 dark:bg-stone-900 px-8 py-16">
        <div className="max-w-4xl mx-auto grid grid-cols-3 gap-8 text-center">
          <div>
            ...
            <h3 className="font-semibold mb-1">Bucătărie Autentică</h3>
            <p className="text-sm text-stone-500 dark:text-stone-400">Rețete tradiționale preparate cu pasiune</p>
          </div>
          <div>
            <div className="text-3xl mb-2">🌿</div>
            <h3 className="font-semibold mb-1">Produse Proaspete</h3>
            <p className="text-sm text-stone-500 dark:text-stone-400">Ingrediente locale și de sezon</p>
          </div>
          <div>
            <div className="text-3xl mb-2">🍷</div>
            <h3 className="font-semibold mb-1">Selecție de Vinuri</h3>
            <p className="text-sm text-stone-500 dark:text-stone-400">O selecție de vinuri alese cu grijă</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-amber-500 text-black px-8 py-12">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl font-bold mb-2">Rezervați masa</h2>
          <p className="mb-4">Sunați-ne sau rezervați online</p>
